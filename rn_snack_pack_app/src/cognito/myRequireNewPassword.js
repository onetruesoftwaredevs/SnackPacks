...
import { FormField, AmplifyButton, LinkCell, Header, ErrorRow } from '../aws-amplify-react-native/dist/AmplifyUI';
import AuthPiece from '../aws-amplify-react-native/dist/Auth/AuthPiece';

const logger = new Logger('SignIn');

export default class MyRequireNewPassword extends AuthPiece {
    constructor(props) {
        super(props);
